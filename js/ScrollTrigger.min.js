...
!(function (e, t) {
  ...
  var E =
    ((Observer.prototype.init = function init(e) {
      ...
      function af(e) {
        if (!Re(e)) {
          ;(e = M(e, s)), H && (oe = !0)
          const t = (1 === e.deltaMode ? r : 2 === e.deltaMode ? Ce.innerHeight : 1) * f
  ...
  function gb(e, t) {
    for (const r in t) r in e || (e[r] = t[r])
    return e
  }
  ...
  var He,
    ...
    Q =
          ...
          ;(Te.previous = function () {
            ...
            (Te.update = function (e, t, r) {
              if (!pe || r || e) {
                ...
                if (x) {
                  const v = pe ? (u / pe.duration()) * (pe._caScrollDist || 0) : u
            ...
            (Te.disable = function (e, t) {
              if (
                ...
                for (let r = At.length; r--; ) if (At[r].scroller === be && At[r] !== Te) return
      ...
      (ScrollTrigger.defaults = function defaults(e) {
        if (e) for (const t in e) Ot[t] = e[t]
        return Ot
      }),
      (ScrollTrigger.disable = function disable(t, r) {
        ;(vt = 0),
          ...
          c.kill(),
          Ja(pb)
        for (let e = 0; e < ze.length; e += 3) qb(pb, ze[e], ze[e + 1]), qb(pb, ze[e], ze[e + 2])
      }),
      ...
      (ScrollTrigger.config = function config(e) {
        ...
        ;(t && clearInterval(u)) || ((u = t) && setInterval(Ab, t)),
          ...
          'autoRefreshEvents' in e &&
            (Ja(pb) || Ja(ob, e.autoRefreshEvents || 'none'), (h = -1 === (e.autoRefreshEvents + '').indexOf('resize')))
      }),
      ...
      (ScrollTrigger.isInViewport = function isInViewport(e, t, r) {
        const n = (Ka(e) ? J(e) : e).getBoundingClientRect(),
          o = n[r ? mt : yt] * t || 0
          ...
          (k &&
            ...
            (function ignoreDrag() {
              if (o) {
                ...
                const e = Ba(n.deltaY / 2),
                  t = S(v.v - e)
                if (h && t !== v.v + v.offset) {
                  v.offset = t - v.v
                  const r = Ba((parseFloat(h && h._gsap.y) || 0) - v.offset)
